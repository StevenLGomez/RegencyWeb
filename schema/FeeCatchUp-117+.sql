...
INSERT INTO deposit (id, dt, is_reconciled) VALUES (134, '20221005', 0); -- Deposit 134
INSERT INTO fees(dt, ck_no, amount, fk_lot_id, fk_deposit_id, note) VALUES('20221025', 560008707,  40,   3, 134, 'US Title');
INSERT INTO fees(dt, ck_no, amount, fk_lot_id, fk_deposit_id, note) VALUES('20220511',    219440,  40,  62, 134, 'Investors Title');
UPDATE deposit SET amount = (SELECT SUM(amount) FROM fees WHERE fk_deposit_id = 134)  WHERE id = 134;

UPDATE fees SET dt = "20220926", note = "Investors Title File 738496" WHERE fk_deposit_id = 134 AND fk_lot_id = 62; -- Corrections for above
